...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://服务器IP:3306/crawlarticle?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai","数据库用户名","数据库密码")
                // 全局配置
                ...
                .packageConfig(builder -> {
                    // 设置父包名
                    builder.parent("com.demo.article")
                            .entity("pojo")
